...
GROQ_API = '' # Não subir de jeito nenhum pro git!
client = Groq(api_key=GROQ_API)

# Prompts para testar
prompt_1_llama3_2_90b = {
    "nome_experimento": "prompt_1_llama-3.2-90b-text-preview",
...
prompt_2_llama3_2_90b = {
    "nome_experimento": "prompt_2_llama-3.2-90b-text-preview",
    "modelo": "llama-3.2-90b-text-preview", 
    "atributo_opiniao_inferida": "opiniao_inferida",
...
prompt_3_llama3_2_90b = {
    "nome_experimento": "prompt_3_llama-3.2-90b-text-preview",
    "modelo": "llama-3.2-90b-text-preview", 
    "atributo_opiniao_inferida": "opiniao_inferida",
